...
import { Plus, Pencil, Trash2, Sparkles, Tags } from "lucide-react"
...
export default function CategoriesPage() {
  ...
  const handleCreate = async () => {
    ...
    await categoriesApi.create({ name: newCategory, description: newDescription })
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="animate-fade-in-up">
        ...
        <h1 className="text-4xl font-serif text-foreground">Categorías</h1>
      ...
      <Card className="border-border/50 card-luxury animate-fade-in-up stagger-1 opacity-0">
        <div className="p-6 border-b border-border/30">
          <h2 className="text-lg font-serif">Nueva Categoría</h2>
        </div>
        <div className="p-6">
              ...
              <CardContent className="p-5">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-1">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg" onClick={() => handleDelete(category.id)}>
